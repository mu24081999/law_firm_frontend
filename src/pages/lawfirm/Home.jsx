...
function LawFirmHome() {
  ...
  const summaryCards = [
    ...
    },
    {
      ...
      value: analyticsData?.completedCases ?? "—",
      change: "-4.3%",
      isPositive: false,
      icon: <ClipboardDocumentListIcon className="w-6 h-6 text-warning-500" />,
    },
    {
      title: "Revenue This Month",
      value: `$${
        analyticsData?.invoice?.monthlyRevenueData?.datasets?.[0]?.data?.at?.(
          -1
        ) ?? 0
      }`,
      change: "+12.2%",
  ...
  const caseDistributionData = analyticsData?.cases?.distribution ?? {
    labels: [],
    datasets: [],
  };

  const monthlyRevenueData = analyticsData?.invoice?.monthlyRevenueData ?? {
    labels: [],
    datasets: [],
  };
  ...
  return (
    <div>
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 py-5">
          <div className="bg-blue-50 p-4">
            <h2 className="text-sm font-medium text-blue-700 border-b pb-1">
              Total Clients
            </h2>
            <p className="text-3xl font-bold text-blue-900 mt-2">
              {analyticsData?.totalClients ?? "—"}
          ...
          <div className="bg-yellow-50 p-4">
            <h2 className="text-sm font-medium text-yellow-700 border-b pb-1">
              Active Service Requests
            </h2>
            <p className="text-3xl font-bold text-yellow-900 mt-2">
              {analyticsData?.activeCases ?? "—"}
          ...
          <div className="bg-green-50 p-4">
            <h2 className="text-sm font-medium text-green-700 border-b pb-1">
              Completed Service Requests
            </h2>
            <p className="text-3xl font-bold text-green-900 mt-2">
              {analyticsData?.completedCases ?? "—"}
